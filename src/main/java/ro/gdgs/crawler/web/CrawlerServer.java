...
public class CrawlerServer extends HttpServlet {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			UserService userSrv = UserServiceFactory.getUserService();
			...
			if (userSrv.isUserLoggedIn()) {
				...
				String loginUrl = userSrv.createLoginURL(redirectUrl.toString());
